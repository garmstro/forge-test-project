...
class Settings(BaseSettings):
    ...
    RATE_LIMIT_AUTH: str = "10/minute"        # /users/register, /users/token
    RATE_LIMIT_LINKS: str = "60/minute"       # /links/*
    RATE_LIMIT_ANALYTICS: str = "30/minute"   # /analytics/*
    RATE_LIMIT_REDIRECTS: str = "120/minute"  # /{slug}
